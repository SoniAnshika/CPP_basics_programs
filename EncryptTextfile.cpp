...
int main()
{
  ...
  out.open("Tmp.txt" );
   ...
   /*Writing content to be encrrypted. */
   out<<"Welcome to JUET Guna MP."<<endl;
   
   /*Closing the file write mode. */
   out.close();
   ...
   if(fout.good()==0)
   {
    ...
    /*Encrypting the content of the file "Tmp.txt" and printing it in temporary file. */
    while(fin)
    {
    fin.getline(str,100);
   ...
   cout<<"\n\nEncrypted content of the file is :"<<endl;
   while(fin1)
   {
